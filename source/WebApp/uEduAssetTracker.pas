...
begin
  ...
  begin
    ...
    lTVI.HTMLTemplateItems.Values['FIELDDESC'] := 'Type       ';
    lTVI.HTMLTemplateItems.Values['FIELDVALUE'] := dm.tAssetSA.FieldByName('typeId.name').AsString;
    lTVI := tvScan.Items.Add;
    ...
    lTVI := tvScan.Items.Add;
    lTVI.HTMLTemplateItems.Values['FIELDDESC'] := 'Person     ';
    lTVI.HTMLTemplateItems.Values['FIELDVALUE'] := dm.tAssetSA.FieldByName('roomId.personId.name').AsString;
    lTVI := tvScan.Items.Add;
    lTVI.HTMLTemplateItems.Values['FIELDDESC'] := 'Room       ';
    lTVI.HTMLTemplateItems.Values['FIELDVALUE'] := dm.tAssetSA.FieldByName('roomId.nameplate').AsString;
    lTVI := tvScan.Items.Add;
    lTVI.HTMLTemplateItems.Values['FIELDDESC'] := 'Grade      ';
    lTVI.HTMLTemplateItems.Values['FIELDVALUE'] := dm.tAssetSA.FieldByName('roomId.grade').AsString;
    lTVI := tvScan.Items.Add;
    lTVI.HTMLTemplateItems.Values['FIELDDESC'] := 'Building   ';
    lTVI.HTMLTemplateItems.Values['FIELDVALUE'] := dm.tAssetSA.FieldByName('roomId.buildingId.name').AsString;
    lTVI := tvScan.Items.Add;
    lTVI.HTMLTemplateItems.Values['FIELDDESC'] := 'Vendor     ';
    lTVI.HTMLTemplateItems.Values['FIELDVALUE'] := dm.tAssetSA.FieldByName('vendorId.name').AsString;
    lTVI := tvScan.Items.Add;
